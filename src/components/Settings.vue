    ...
    <div class="settings-body">
      ...
      <div class="settings-section">
        <div class="section-header">
          ...
          <span class="section-hint hint-warn">明文保存在本机，请勿分享</span>
        </div>
        <el-input
          v-model="form.cookie"
      ...
      <div class="settings-section">
        ...
        <el-select v-model="form.quality" size="large" style="width: 100%">
          ...
          <el-option label="蓝光 1080P (QN 400)" value="400" />
      ...
      <div class="settings-section">
        ...
        <div class="db-row">
          <el-input
            ...
            placeholder="D:\Data\bilibili_recorder.db"
            clearable
            size="large"
          />
...
function onOpen() {
  ...
  form.preserve_source_after_convert = store.settings.preserve_source_after_convert ?? true
