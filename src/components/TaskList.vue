        ...
        >
          ...
          <div class="task-main">
            <div class="task-header-row">
              ...
              <span v-if="task.actual_qn" class="task-quality-badge">
                {{ getQualityText(task.actual_qn) }} · {{ task.stream_type }}
              </span>
          ...
          <div class="task-actions">
            ...
            <button
              ...
              :disabled="['preparing', 'recording', 'finalizing'].includes(task.status)"
              title="删除任务"
            >
...
function getQualityText(qn: number) {
...
async function openFile(task: RecordTask) {
  ...
  try {
    await store.openRecordingFile(task.id)
  } catch (e) {
...
async function openFolder(task: RecordTask) {
  ...
  try {
    await store.revealRecordingFile(task.id)
  } catch (e) {
