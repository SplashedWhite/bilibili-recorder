          ...
          <div class="header-left">
            <div class="logo-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M8 5 5.5 2.8M16 5l2.5-2.2" />
                <rect x="3" y="6" width="18" height="14" rx="4" />
                <circle cx="9" cy="13" r="1" fill="currentColor" stroke="none" />
                <circle cx="15" cy="13" r="1" fill="currentColor" stroke="none" />
                <path d="M9 17c1.7.8 4.3.8 6 0" />
              </svg>
            </div>
            <h1>Bilibili 直播录制</h1>
          </div>
...
:root {
  ...
  --color-primary: #00aeec;
  --color-primary-hover: #009bd3;
  --color-primary-light: rgba(0, 174, 236, 0.1);
...
.logo-icon {
  width: 34px;
  height: 34px;
  background: linear-gradient(135deg, #00aeec 0%, #5bcff5 68%, #fb7299 100%);
  border-radius: var(--radius-sm);
  display: flex;
  align-items: center;
  justify-content: center;
  color: white;
  box-shadow: 0 2px 8px rgba(0, 174, 236, 0.28);
  flex-shrink: 0;
}
