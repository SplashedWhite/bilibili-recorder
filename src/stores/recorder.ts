...
export const useRecorderStore = defineStore('recorder', () => {
  ...
  async function openRecordingFile(taskId: number) {
    await invoke('open_recording_file', { taskId })
  }

  async function revealRecordingFile(taskId: number) {
    await invoke('reveal_recording_file', { taskId })
  }
